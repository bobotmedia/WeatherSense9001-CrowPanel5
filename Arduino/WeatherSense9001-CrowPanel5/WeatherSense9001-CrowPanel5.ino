//============================================================================
// TITLE:         WeatherSense9001-CrowPanel5.ino
// DATE:          07/30/2024
...
//
// DESCRIPTION:   Displays weather conditions on CrowPanel 5.0"
...
void setup()
{
  ...
  if (llLogLevel == MAX) {Serial.println("WeatheratorCrow5");} else {Serial.println("WC5");}
